...
namespace UnityEditor.XCodeEditor
{
	public partial class XCProject : System.IDisposable
	{
		...
		{	
			...
			Debug.Log( "Adding otherCFlags..." );
			foreach( string otherCFlag in mod.otherCFlags ) {
				this.AddOtherCFlags(otherCFlag);
			}
			
			Debug.Log( "Adding otherLDFlags..." );
			foreach( string otherLDFlag in mod.otherLDFlags ) {
				this.AddOtherLDFlags(otherLDFlag);
			}
